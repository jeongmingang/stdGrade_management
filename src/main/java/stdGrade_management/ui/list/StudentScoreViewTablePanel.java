...
public class StudentScoreViewTablePanel extends AbstractCustomTablePanel<StudentScoreView> {
	public StudentScoreViewTablePanel() {
	}
	...
	protected void setAlignAndWidth() {
		...
		// 컬럼별 너비 조정
		setTableCellWidth(100, 150, 100 ,100, 100, 100, 100, 100, 100);	
	}
	...
	public Object[] toArray(StudentScoreView t) {
		return new Object[] {
						...
						t.getSoc(),
						t.getSci(),
						String.format("%.1f", t.getAvgScore())
					};
	}
